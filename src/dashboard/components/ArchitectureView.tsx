        ...
        <div className="border border-white/[0.07] rounded-lg bg-[#101013]  p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              ...
              <div className="flex-1 bg-white/[0.02] border border-white/[0.07] p-3 rounded-lg text-zinc-500 text-[11px]">Validates Access token or HMAC webhook signatures.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#101013] border border-white/[0.07] p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-semibold px-1">→</div>
              <div className="flex-1 bg-white/[0.02] border border-white/[0.07] p-3 rounded-lg text-zinc-500 text-[11px]">Routes agent commands and proxies container preview ports.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#101013] border border-white/[0.07] p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-teal-500 font-semibold px-1">→</div>
              <div className="flex-1 bg-white/[0.02] border border-white/[0.07] p-3 rounded-lg text-zinc-500 text-[11px]">Plans steps using Llama 3.1 8B and manages human approval gates.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#101013] border border-white/[0.10] p-3 rounded-lg shrink-0">
                <div className="text-[#4cc38a] font-semibold mb-0.5">4. Isolated Sandbox VM</div>
                <div className="text-[11px] text-zinc-500">@cloudflare/sandbox Micro-VM</div>
              </div>
              <div className="hidden md:flex text-teal-500 font-semibold px-1">→</div>
              <div className="flex-1 bg-white/[0.02] border border-white/[0.07] p-3 rounded-lg text-zinc-500 text-[11px]">Isolated micro-container running git, test suites, and edits.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#101013] border border-white/[0.07] p-3 rounded-lg shrink-0">
                <div className="text-[#c9a227] font-semibold mb-0.5">5. Outbound Egress Gate</div>
                <div className="text-[11px] text-zinc-500">Zero-Trust Outbound Proxy</div>
              </div>
              <div className="hidden md:flex text-teal-500 font-semibold px-1">→</div>
              <div className="flex-1 bg-white/[0.02] border border-white/[0.07] p-3 rounded-lg text-zinc-500 text-[11px]">Dummy credentials swapped with real keys safely on Worker wire.</div>
            </div>
          </div>
        </div>
      </div>
