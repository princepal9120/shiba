              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[10px] font-mono text-zinc-300 bg-white/[0.04] border border-white/[0.10] px-1.5 py-0.5 rounded-md whitespace-nowrap">
                      {recipe.cadence}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="text-xs font-semibold self-start border rounded-md px-2.5 py-1 transition-colors disabled:opacity-50 text-zinc-300 border-white/[0.10] bg-white/[0.04] hover:bg-white/[0.07] flex items-center gap-1.5"
                  >
                    {busyId === recipe.id ? (
                      <>
                ...
                <div key={a.id} className="py-2.5 flex items-center justify-between gap-3 hover:bg-[#101013] -mx-2 px-2 rounded-lg transition-colors">
                  ...
                  {a.triggers.some((t) => t.kind === "manual") ? (
                    <button
                      ...
                      className="text-xs font-semibold border border-white/[0.10] text-zinc-300 bg-white/[0.04] hover:bg-white/[0.07] rounded-md px-2.5 py-1 shrink-0 transition-colors disabled:opacity-50 flex items-center gap-1.5"
                    >
                      {busyId === `run-${a.id}` ? (
                        <>
                          <span className="animate-spin inline-block w-3 h-3 border-2 border-[#2dd4bf] border-t-transparent rounded-md" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="border border-white/[0.07] rounded-lg bg-[#101013]  p-5 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono uppercase bg-[#4cc38a]/15 text-[#4cc38a] border border-[#4cc38a]/30 px-2 py-0.5 rounded-md">
                Signature Verified
              </span>
            </div>
            ...
            <div className="bg-[#101013] p-2.5 rounded-lg border border-white/[0.07] flex items-center justify-between text-xs font-mono">
              ...
              <button
                ...
                className="text-zinc-300 hover:text-zinc-300 text-[11px] shrink-0 ml-2 transition-colors"
              >
          ...
          <div className="border border-white/[0.07] rounded-lg bg-[#101013]  p-5 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono uppercase bg-white/[0.04] text-zinc-300 border border-white/[0.10] px-2 py-0.5 rounded-md">
                Interactive
              </span>
            </div>
            ...
            <div className="flex flex-col gap-1.5 text-xs font-mono">
              <div className="bg-[#101013] p-2 rounded-md border border-white/[0.07] flex items-center justify-between">
                <span>Commands: <code className="font-mono text-zinc-300 bg-white/[0.04] rounded-md px-1.5">/api/slack/command</code></span>
                <button type="button" onClick={() => copyToClipboard("/api/slack/command", "slack1")} className="text-zinc-300 hover:text-zinc-300 text-[11px] transition-colors">
              ...
              <div className="bg-[#101013] p-2 rounded-md border border-white/[0.07] flex items-center justify-between">
                ...
                <button type="button" onClick={() => copyToClipboard("/api/slack/events", "slack2")} className="text-zinc-300 hover:text-zinc-300 text-[11px] transition-colors">
              ...
              <div className="bg-[#101013] p-2 rounded-md border border-white/[0.07] flex items-center justify-between">
                ...
                <button type="button" onClick={() => copyToClipboard("/api/slack/interact", "slack3")} className="text-zinc-300 hover:text-zinc-300 text-[11px] transition-colors">
