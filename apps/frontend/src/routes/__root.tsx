...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review, approve, and observe autonomous coding tasks on your own Cloudflare account." },
      { property: "og:title", content: "AI Coworker Dashboard" },
      {
        property: "og:description",
        content: "Review, approve, and observe autonomous coding tasks on your own Cloudflare account.",
      },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/assets/mascot/pet-logo.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:image", content: "/assets/mascot/pet-logo.png" },
      { title: "AI Coworker Dashboard · Cloudflare Native Coding Agent" },
    ],
    links: [
