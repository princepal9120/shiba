      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col gap-6">
        <div className="border-b border-black/[0.08] pb-4">
          <h2 className="text-base font-semibold text-[#222320] flex items-center gap-2">
            ...
            <span className="text-xs font-mono px-2 py-0.5 rounded-none bg-[#0000a8]/10 border border-[#0000a8]/15 text-[#0000a8]">Zero-Trust</span>
          </h2>
        ...
        <div className="border border-black/[0.08] rounded-none bg-[#f6f4ed] shadow-[2px_2px_0_var(--paper-shadow)] p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#fffef8] border border-black/[0.08] p-3 rounded-none shrink-0">
              ...
              <div className="flex-1 bg-[#fffef8]/60 border border-black/[0.08]/80 p-3 rounded-none text-[#6a6f63] text-[11px]">Validates Access token or HMAC webhook signatures.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#fffef8] border border-black/[0.08] p-3 rounded-none shrink-0">
              ...
              <div className="hidden md:flex text-[#0000a8] font-bold px-1">→</div>
              <div className="flex-1 bg-[#fffef8]/60 border border-black/[0.08]/80 p-3 rounded-none text-[#6a6f63] text-[11px]">Routes agent commands and proxies container preview ports.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#fffef8] border border-black/[0.08] p-3 rounded-none shrink-0">
              ...
              <div className="hidden md:flex text-[#0000a8] font-bold px-1">→</div>
              <div className="flex-1 bg-[#fffef8]/60 border border-black/[0.08]/80 p-3 rounded-none text-[#6a6f63] text-[11px]">Plans steps using Llama 3.1 8B and manages human approval gates.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#fffef8] border border-[#0000a8]/40 p-3 rounded-none shrink-0">
              ...
              <div className="hidden md:flex text-[#0000a8] font-bold px-1">→</div>
              <div className="flex-1 bg-[#fffef8]/60 border border-black/[0.08]/80 p-3 rounded-none text-[#6a6f63] text-[11px]">Isolated micro-container running git, test suites, and edits.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-[#fffef8] border border-black/[0.08] p-3 rounded-none shrink-0">
              ...
              <div className="hidden md:flex text-[#0000a8] font-bold px-1">→</div>
              <div className="flex-1 bg-[#fffef8]/60 border border-black/[0.08]/80 p-3 rounded-none text-[#6a6f63] text-[11px]">Dummy credentials swapped with real keys safely on Worker wire.</div>
            </div>
          </div>
        </div>
      </div>
