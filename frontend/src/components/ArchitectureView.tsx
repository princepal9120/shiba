  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-y-auto bg-[#f8fafc] text-slate-900 p-4 lg:p-8">
      <div className="max-w-5xl mx-auto w-full flex flex-col gap-6">
        ...
        <div className="border border-slate-200 rounded-xl bg-[#f8fafc] shadow-sm p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-white border border-slate-200 p-3 rounded-lg shrink-0">
              ...
              <div className="flex-1 bg-white/60 border border-slate-200/80 p-3 rounded-lg text-slate-500 text-[11px]">Validates Access token or HMAC webhook signatures.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-white border border-slate-200 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-blue-600 font-bold px-1">→</div>
              <div className="flex-1 bg-white/60 border border-slate-200/80 p-3 rounded-lg text-slate-500 text-[11px]">Routes agent commands and proxies container preview ports.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-white border border-slate-200 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-blue-600 font-bold px-1">→</div>
              <div className="flex-1 bg-white/60 border border-slate-200/80 p-3 rounded-lg text-slate-500 text-[11px]">Plans steps using Llama 3.1 8B and manages human approval gates.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              ...
              <div className="hidden md:flex text-blue-600 font-bold px-1">→</div>
              <div className="flex-1 bg-white/60 border border-slate-200/80 p-3 rounded-lg text-slate-500 text-[11px]">Isolated micro-container running git, test suites, and edits.</div>
            </div>
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="w-full md:w-56 bg-white border border-slate-200 p-3 rounded-lg shrink-0">
              ...
              <div className="hidden md:flex text-blue-600 font-bold px-1">→</div>
              <div className="flex-1 bg-white/60 border border-slate-200/80 p-3 rounded-lg text-slate-500 text-[11px]">Dummy credentials swapped with real keys safely on Worker wire.</div>
            </div>
          </div>
        </div>
      </div>
